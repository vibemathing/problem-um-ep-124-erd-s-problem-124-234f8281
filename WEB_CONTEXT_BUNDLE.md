...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-124-erd-s-problem-124-234f8281-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-124"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-124-erd-s-problem-124-234f8281-v1",
      "problem_contract_sha256": "c46cd15b7dc81110d881eda242e4c90363fb26ea6aa8c6ae9508bdba6ec99fe6",
      "problem_id": "problem:um-ep-124-erd-s-problem-124-234f8281",
      "route_id": "route:um-ep-124-erd-s-problem-124-234f8281-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-124-erd-s-problem-124-234f8281-source-fidelity-01",
      "graph_id": "graph:um-ep-124-erd-s-problem-124-234f8281-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-124-erd-s-problem-124-234f8281-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-124-erd-s-problem-124-234f8281-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For any $d\\geq 1$ and $k\\geq 0$ let $P(d,k)$ be the set of integers which are the sum of distinct powers $d^i$ with $i\\geq k$. Let $3\\leq d_1<d_2<\\cdots <d_r$ be integers such that $ \\sum_{1\\leq i\\leq r}\\frac{1}{d_r-1}\\geq 1. $ Can all sufficiently large integers be written as a sum of the shape $\\sum_i c_ia_i$ where $c_i\\in \\{0,1\\}$ and $a_i\\in P(d_i,0)$? If we further have $\\mathrm{gcd}(d_1,\\ldots,d_r)=1$ then, for any $k\\geq 1$, can all sufficiently large integers be written as a sum of the shape $\\sum_i c_ia_i$ where $c_i\\in \\{0,1\\}$ and $a_i\\in P(d_i,k)$?"
          },
          "statement_sha256": "51d993f9eb61b1fc07dfb592e6a0da2430473b6982b9924c10f521c7ec126633"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-124-erd-s-problem-124-234f8281-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-124-erd-s-problem-124-234f8281-root",
      "route_id": "route:um-ep-124-erd-s-problem-124-234f8281-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-124-e2c8f4bdf0fc",
        "url": "https://www.unsolvedmath.com/problems/EP-124"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
